...
<main class="form-signin w-100 m-auto">
    <form action="login.php?action=login" method="post">
        ...
        <div class="form-floating">
            <input type="text" name="primer_apellido" class="form-control" id="floatingPrimerApellido" placeholder="Primer apellido">
            <label for="floatingPrimerApellido">Primer apellido</label>
        </div>
        <div class="form-floating">
            <input type="text" name="segundo_apellido" class="form-control" id="floatingSegundoApellido" placeholder="Segundo apellido">
